...
<div class="box">
        ...
        <div class="connet" style="height: 70%;">
            ...
            $PageSize=8;
            $result=mysql_query("select count(ID) from user WHERE CONCAT(account,realname,sex,root) LIKE '%$text%'",$conn);
            ...
            $pre = ($Page-1)*$PageSize;
                ...
                $sql="SELECT * FROM user WHERE CONCAT(account,realname,sex,root) LIKE '%$text%' limit $pre,$PageSize ";
