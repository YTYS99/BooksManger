...
<div class="box">
    ...
    <div class="connet" style="height: 70%;">
        ...
        $PageSize=8;
        $result=mysql_query("select count(ID) from new WHERE CONCAT(title,date,Editor) LIKE '%$text%'",$conn);
        ...
        $sql="SELECT * FROM new WHERE CONCAT(title,date,Editor) LIKE '%$text%' limit $pre,$PageSize ";
        ...
        <table border="0" width="100%"  cellspacing="0" id="tab" >
            <?php while($row=mysql_fetch_assoc($result)){
                ...
                <tr>
                    ...
                    <td width="20%"><?php echo $row['Editor']; ?></td>
                    <td width="20%"><?php echo $row['date']; ?></td>
                    <td width = "7.5%" ><a href="../umeditor-1.2.3/_examples/update.php?id3=<?php echo $row['id'];?>">修改</a ></td >
                    <td width = "7.5%" ><a href = "delete.php?id5=<?php echo $row['id'];?>" > 删除</a ></td >
                </tr>
            <?php }?>
        </table>
