...
<div class="box">
    ...
    <div class="input-box">
        <!--图书查询-->
        <form action="SearchNote.php" method="post">
            <div class="input1">
    ...
    <div class="connet" style="height: 70%;">
        ...
        $PageSize=8;
        $result=mysql_query("select count(ID) from items WHERE CONCAT(title,date,Usertype) LIKE '%$text%' AND type='通知公告'",$conn);
        ...
        $sql="SELECT * FROM items WHERE CONCAT(title,date,Usertype) LIKE '%$text%' AND type='通知公告' limit $pre,$PageSize ";
